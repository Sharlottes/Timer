...
class TimerPage extends SubTimerPage {
...
class TimerPageState extends SubTimerPageState {
  ...
  void _resetTimer(BuildContext context) {
    recordList.clear();
    setState(() {
      context.read<TimerValue>().time = const Duration();
      _timer?.stop();
      _timerPlaying = false;
    });
  }
        ...
        builder: (_) => Container(
          ...
          child: SafeArea(
            ...
            child: CupertinoTimerPicker(
              ...
              initialTimerDuration: context.read<TimerValue>().time,
              onTimerDurationChanged: (Duration newDuration) {
                setState(() => context.read<TimerValue>().time = newDuration);
              },
            ),
          ),
        )
    ...
    return ListenableProvider(
        ...
        builder: (context, _) {
          _timer ??= Ticker((duration) {
            ...
            TimerValue times = context.read<TimerValue>();
            setState((){
                times.time = duration;
            });
          });
                            ...
                            child: AnimatedContainer(
                                ...
                                child: Padding(
                                    ...
                                    child: Column(children: [
                                      Text.rich(
                                        TextSpan(
                                            text: formatTime(context.watch<TimerValue>().time),
                                            children: [
                                              TextSpan(
                                                  text: ' . ${formatTime(context.watch<TimerValue>().time, onlyMicro: true)}',
                                          ...
                                          child: Row(
                                              ...
                                              children: [
                                                Text.rich(
                                                    TextSpan(
                                                        text: "시작 시간    ",
                                                        children: [TextSpan(text: formatTime(context.watch<TimerValue>().initTime, all: true)),]
                                                    ),
...
class TimerValue extends Times {
